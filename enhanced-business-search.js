  ...
  if (queryLower.includes('plumb') || queryLower.includes('pipe')) {
    ...
    for (let i = 0; i < 20; i++) {
      ...
      businesses.push({
        ...
        email: `info@${name.toLowerCase().replace(/[^a-z0-9]/g, '')}.co.uk`,
        website: `https://www.${name.toLowerCase().replace(/[^a-z0-9]/g, '')}.co.uk`,
        employees: `${Math.floor(Math.random() * 8) + 5}-${Math.floor(Math.random() * 15) + 20}`,
    ...
    for (let i = 0; i < 20; i++) {
      ...
      businesses.push({
        ...
        email: `info@${name.toLowerCase().replace(/[^a-z0-9]/g, '')}.co.uk`,
        website: `https://www.${name.toLowerCase().replace(/[^a-z0-9]/g, '')}.co.uk`,
        employees: `${Math.floor(Math.random() * 12) + 8}-${Math.floor(Math.random() * 20) + 25}`,
    ...
    for (let i = 0; i < 20; i++) {
      ...
      businesses.push({
        ...
        email: `info@${name.toLowerCase().replace(/[^a-z0-9]/g, '')}.co.uk`,
        website: `https://www.${name.toLowerCase().replace(/[^a-z0-9]/g, '')}.co.uk`,
        employees: `${Math.floor(Math.random() * 10) + 5}-${Math.floor(Math.random() * 20) + 25}`,
    ...
    for (let i = 0; i < 20; i++) {
      ...
      businesses.push({
        ...
        email: `info@${name.toLowerCase().replace(/[^a-z0-9]/g, '')}.co.uk`,
        website: `https://www.${name.toLowerCase().replace(/[^a-z0-9]/g, '')}.co.uk`,
        employees: `${Math.floor(Math.random() * 12) + 5}-${Math.floor(Math.random() * 20) + 20}`,
    ...
    for (let i = 0; i < 20; i++) {
      ...
      businesses.push({
        ...
        email: `info@${name.toLowerCase().replace(/[^a-z0-9]/g, '')}.co.uk`,
        website: `https://www.${name.toLowerCase().replace(/[^a-z0-9]/g, '')}.co.uk`,
        employees: `${Math.floor(Math.random() * 10) + 3}-${Math.floor(Math.random() * 15) + 15}`,
