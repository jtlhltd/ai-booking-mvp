...
export async function callLeadInstantly({
  ...
  try {
    ...
    // Final per-lead overlay: shallow variableValues merge only, after sequence
    // and A/B layers. Do not replace the rest of assistantOverrides from lead JSON.
    const leadDialVars = normalizeLeadDialContext(leadDialContext);
