 ...
 */
export async function sendWelcomeEmail({ clientKey, businessName, ownerEmail, apiKey, systemPrompt, businessSize, monthlyLeads, goals, urgency }) {
  try {
          ...
          <div class="content">
            ...
            <div class="section">
              ...
              <ul style="margin: 12px 0; line-height: 1.8;">
                ...
                ${goals ? `<li><strong>Primary Goal:</strong> ${goals}</li>` : ''}
            ...
            <div class="section">
              ...
              <p>After your trial, we'll discuss custom pricing based on your specific needs and lead volume. Cancel anytime, no questions asked.</p>
            </div>
