 ...
 */
export async function sendWelcomeEmail({ clientKey, businessName, ownerEmail, apiKey, systemPrompt, businessSize, monthlyLeads, urgency }) {
  try {
          ...
          <div class="content">
            ...
            <div class="section">
              ...
              <ul style="margin: 12px 0; line-height: 1.8;">
                ...
                ${urgency ? `<li><strong>Response Time:</strong> ${urgency}</li>` : ''}
              </ul>
            </div>
