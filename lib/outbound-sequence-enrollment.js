 ...
 */
export async function setLeadOutboundSequenceEnrollment(params) {
  const { clientKey } = params;
  return startSpan(
    { name: 'outbound.sequence.enroll', op: 'outbound.sequence', attributes: { clientKey } },
    async () => setLeadOutboundSequenceEnrollmentInner(params)
  );
}

async function setLeadOutboundSequenceEnrollmentInner({
  clientKey,
  leadPhone,
  enrolled,
  actor = 'operator',
 ...
 */
export async function setLeadsOutboundSequenceEnrollmentBulk(params) {
  const { clientKey } = params;
  return startSpan(
    { name: 'outbound.sequence.enroll_bulk', op: 'outbound.sequence', attributes: { clientKey } },
    async () => setLeadsOutboundSequenceEnrollmentBulkInner(params)
  );
}

async function setLeadsOutboundSequenceEnrollmentBulkInner({
  clientKey,
  leadPhones,
  enrolled,
  actor = 'operator',
